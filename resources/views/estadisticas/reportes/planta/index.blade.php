...
@section('titulo')
    <div class="w-100 alto">
        <div class="box-header with-border">
            <a href="{{route('planta-pdfgeneral.index')}}" class="btn btn-success btn-sm pull-right rounded-pill text-white" style="width: 130px;"><i class="fas fa-file">&nbsp;</i>{{ __('adminlte::adminlte.all-records') }}</a> 
        </div>
    </div>
                ...
                @foreach ($plantas as $item)
                    <tr>
                        ...
                        <td class="text-center" style="border-left: 1px solid #dee2e6; width: 130px !important;">                          
                            <a href="{{route('planta-pdfindividual.index', ['planta' => $item->id])}}" class="tooltipsC btn btn-sm btn-warning" title="Editar Registro">
                                <i class="fas fa-file"></i> 
                            </a>                            
                        </td>
                    </tr>
